...
typedef Magnum::Vector3   WPos;     // ћировые координаты.
typedef Magnum::Vector3i  SPos;     //  оординаты сектора.
typedef Magnum::Vector3i  WBPos;    //  оординаты блока в мире.
typedef Magnum::Vector3i  SBPos;    //  оординаты блока в секторе.
typedef Magnum::Vector3i  STPos;    //  оординаты тессел€тора в секторе.
