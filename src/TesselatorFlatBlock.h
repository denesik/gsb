...
typedef std::bitset<8 * 8 * 8> TessFlatBlockData;
...
public:
  ...
  static TessFlatBlockData &ToMicroblockData(TesselatorData &data);

  static const TessFlatBlockData &ToMicroblockData(const TesselatorData &data);
